...
├⍟ ᴏᴡɴᴇʀ : <a href={https://t.me/onefighterarmy}>SUJAY 😎</a> 
├⍟ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a>
├⍟ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 𝟹</a> 
├⍟ ᴅᴀᴛᴀʙᴀꜱᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
├⍟ ꜱᴇʀᴠᴇʀ : <a href='https://her/'>ʜᴇʀᴏᴋᴜ</a> 
├⍟ ꜱᴛᴀᴛᴜꜱ : ᴠ4.8 [ ꜱᴛᴀʙʟᴇ ]
╰───────────────⍟</b>"""
...
•─────•─────────•─────•
💵 ᴜᴘɪ ɪᴅ -  ⚠️ <b><u>ᴛʜɪꜱ ꜱᴇʀᴠɪᴄᴇ ɪꜱ ᴛᴇᴍᴘᴏʀᴀʀʏ OPEN.</u></b>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """📂 <b>Filename:</b> <a href=''>{file_name}</a>
sɪᴢᴇ ⚙️: {file_size}
"""
